...
if sys.version_info[0] < 3:
    #import svm
    #import svmutil
    from NR_IQA.svmutil import *
    from NR_IQA.svm import *
else:
    # if python 3.x version 
    # make sure the file is in libsvm/python folder
    #import svmutil
    from NR_IQA.svm import *
    from NR_IQA.svmutil import svm_load_model
...
def compute_features(img):
    ...
    for itr_scale in range(scalenum):
        ...
        #print(mu_sq)
        sigma = (np.maximum((sigma - mu_sq),-(sigma - mu_sq))) ** 0.5
...
def test_measure_BRISQUE(img):
    ...
    # load model 
    model = svm_load_model("/home/zt/deep_learning/DL_yhb/Image_Fusion/dense-asp/NR_IQA/allmodel")
